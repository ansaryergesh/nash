  ...
  return (
    <div className='form_register thirdstep'>
      <form onSubmit={(e) => openCodeModal(e)}>
        <DropFileDoc setFiles={setFiles} inputContent="Письмо взыскателю (Спорная ситуация)" />
        <DropFile setFiles={setFiles} inputContent="Письмо возражение Нотариусу (если есть исполнительная надпись)" />
        <DropFile setFiles={setFiles} inputContent="Письмо взыскателю и ЧСИ (ИЛ)" />
