...
const FourthStep = ({setLoading, user, loggedIn}) => {
  ...
  const openCodeModal = (e) => {
    ...
    // e.preventDefault() console.log(loggedIn) if (cookie.get('token') ===
  ...
  return (
    <div>
      <h2>Выберите один из услуг</h2>
        <div class="main">
          <div>
            {/* <h1>200</h1> */}
            <p>Бесплатный</p>
            <ul>
              <li>Отменим Нод. Надпись, исполнительный лист</li>
              <li>Отгоним коллекторов</li>
              <li>Отменим Аресты ЧСИ</li>
            </ul>
            <a href="" target="_blank">Выбрать</a>
          </div>
          <div>
            {/* <h1>250</h1> */}
            <p>Платный</p>
            <ul>
              <li>Платная услуга 1</li>
              <li>Платная услуга 2</li>
              <li>Платная услуга 3</li>
            </ul>
            <a href="" target="_blank">Выбрать</a>
          </div>
        </div>
